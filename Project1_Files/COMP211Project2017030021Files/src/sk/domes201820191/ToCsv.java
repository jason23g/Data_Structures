	...
	public static void main(String[] args) throws IOException {
        ...
        try {
			...
			while (bytesRead > 0) {
				...
				sk.domes201820191.utils.Utils.bytesToIntArray(byteBuffer, intArray);
				if (bytesRead < 0) {
					break;
				}
