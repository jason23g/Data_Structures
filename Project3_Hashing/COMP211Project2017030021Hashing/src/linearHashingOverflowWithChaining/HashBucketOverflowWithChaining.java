...
public class HashBucketOverflowWithChaining {
	private int keysNumber;
	private int[] keys;
	private HashBucketOverflowWithChaining overflowBucket;
    
    
	public HashBucketOverflowWithChaining(int bucketSize) {		// Constructor: initialize variables
	...
	public HashBucketOverflowWithChaining getOverflowBucket() {
	...
	public void insertKey(int key, LinearHashingOverflowWithChaining lh) { // inserts a key to the node
		...
		if (i < bucketSize){				// bucket not full write the new key
		  ...
		  //System.out.println("HashBucket.insertKey: KeysNum = " + keysNum );
			...
			this.overflowBucket = new HashBucketOverflowWithChaining(bucketSize);
			keySpace += bucketSize;
	...
	/*public void deleteKey(int key, LinearHashingOverflowWithChaining lh) { // code not correct
	...
	int removeLastKey(LinearHashingOverflowWithChaining lh) {	// remove bucket last key
	...
	public boolean searchKey(int key, LinearHashingOverflowWithChaining lh) {
	...
	public void splitBucket(LinearHashingOverflowWithChaining lh, int n, int bucketPos, HashBucketOverflowWithChaining newBucket) {	//splits the current bucket
	...
	public void mergeBucket(LinearHashingOverflowWithChaining lh, HashBucketOverflowWithChaining oldBucket) {	//merges the current bucket
